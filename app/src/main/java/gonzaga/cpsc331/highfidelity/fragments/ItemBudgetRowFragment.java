...
public class ItemBudgetRowFragment extends Fragment {
    ...
    public static ItemBudgetRowFragment newInstance(String param1) {
        ItemBudgetRowFragment fragment = new ItemBudgetRowFragment();
